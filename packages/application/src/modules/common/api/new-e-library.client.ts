...
export const BASE_URL_TOKEN_NewELibraryApi = symbolToken<string>('BASE_URL_TOKEN', false);
export const AXIOS_TOKEN_NewELibraryApi = symbolToken<string>('AXIOS_TOKEN', false);

@injectable()
export class NewELibraryApi {
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    protected readonly opts: ClientApiConfig;

    constructor(
        @inject(BASE_URL_TOKEN_NewELibraryApi) @optional() baseUrl = '',
        @inject(AXIOS_TOKEN_NewELibraryApi) @optional() axiosInstance = axios,
    ) {
     ...
     * @body file to upload
     */
    uploadController_uploadFile(body: Blob, cancelToken?: CancelToken): AxiosPromise<FileUploadResponseDto> {
        let url_ = "/upload";
        url_ = url_.replace(/[?&]$/, "");
